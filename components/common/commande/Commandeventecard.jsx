...
/**
 * CommandeVenteCard — carte réutilisable pour commandes de vente & retours.
 *
 * Props :
 *   item     — { cmd, erdat, status, statutGlobal, totalArticles, montantTtc, vgbel, isOffline }
 *   onPress  — () => void
 */
const CommandeVenteCard = ({ item, onPress }) => {
...
export default CommandeVenteCard;
